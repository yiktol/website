...
<div id="navbar-main"> 
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
	  ...
	  <li> <a href="https://bit.ly/3L7PMIH" class="smoothScroll" target="_blank" rel="noopener noreferrer"> Dashboard</a></li>
...
<div id="headerwrap" name="home">
 ...
 <i class="fa fa-heart-o icon"></i>
    ...
    <p>A Lot Can Happen Over a Cup of Coffee, Its AWSome!!! </p>
...
<?php
    ...
    AddCustomer($connection, $name, $email, $message);
    }
?>
<!-- ==== CONTACT ==== -->
  ...
  <div class="container">
    ...
    <div class="row">
	  ...
	  <strong>Please give us your feedback!</strong>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut eaque, laboriosam veritatis, quos non quis ad perspiciatis, totam corporis ea, alias ut unde.</p>
        <form action="<?PHP echo $_SERVER['SCRIPT_NAME'] ?>"  id="contact" method="POST" class="form" role="form">
          <div class="row">
...
<div id="footerwrap">
  <div class="container">
    <div class="row">
      <div class="col-md-8"> <span class="copyright">Copyright &copy; 2015. Design by <a href="http://www.webthemez.com">Webthemez</a></span> </div>
      <div class="col-md-4">
...
function AddCustomer($connection, $name, $email, $message) {
    $n = mysqli_real_escape_string($connection, $name);
    $e = mysqli_real_escape_string($connection, $email);
    $m = mysqli_real_escape_string($connection, $message);


    $query = "INSERT INTO CUSTOMERS (name, email, message) VALUES ('$n', '$e', '$m');";
